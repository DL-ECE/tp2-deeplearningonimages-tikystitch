...
Original file is located at
    https://colab.research.google.com/github/DL-ECE/tp2-deeplearningonimages-tikystitch/blob/master/convolution.ipynb
...
class CNNModel(nn.Module):
    def __init__(self, classes=10):
        ...
        self.fullCoLay_1 = nn.Linear(50*7*7,40)
        self.fullCoLay_2 = nn.Linear(40, 20)
        self.fullCoLay_3 = nn.Linear(20,10)
    ...
    def forward(self, input):
      ...
      y = self.fullCoLay_1(y)
      y=self.activation(y)
      y = self.fullCoLay_2(y)
      y=self.activation(y)
      y = self.fullCoLay_3(y)
      y= self.activation(y)
